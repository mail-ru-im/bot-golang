...
func easyjson9b8f5552DecodeGithubComMailRuImGobotapi(in *jlexer.Lexer, out *Chat) {
...
func easyjson9b8f5552EncodeGithubComMailRuImGobotapi(out *jwriter.Writer, in Chat) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Chat) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9b8f5552EncodeGithubComMailRuImGobotapi(&w, v)
...
func (v *Chat) UnmarshalJSON(data []byte) error {
	...
	easyjson9b8f5552DecodeGithubComMailRuImGobotapi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Chat) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9b8f5552DecodeGithubComMailRuImGobotapi(l, v)
}

...
func easyjson9b8f5552DecodeGithubComDmitryDorofeevGoicqbot(in *jlexer.Lexer, out *Chat) {
...
func easyjson9b8f5552EncodeGithubComDmitryDorofeevGoicqbot(out *jwriter.Writer, in Chat) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Chat) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9b8f5552EncodeGithubComDmitryDorofeevGoicqbot(&w, v)
...
func (v *Chat) UnmarshalJSON(data []byte) error {
	...
	easyjson9b8f5552DecodeGithubComDmitryDorofeevGoicqbot(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Chat) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9b8f5552DecodeGithubComDmitryDorofeevGoicqbot(l, v)
}

...
func easyjson6601e8cdDecodeGithubComDmitryDorofeevGoicqbot5(in *jlexer.Lexer, out *Message) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComDmitryDorofeevGoicqbot5(out *jwriter.Writer, in Message) {
	out.RawByte('{')
	first := true
	_ = first
	{

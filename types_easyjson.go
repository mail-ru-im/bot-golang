...
func easyjson6601e8cdDecodeGithubComMailRuImBotGolang10(in *jlexer.Lexer, out *Admin) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMailRuImBotGolang10(out *jwriter.Writer, in Admin) {
	out.RawByte('{')
	first := true
	_ = first
	{
